...
class HCResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, low_dim=512, low_dim2=128,
                 linear_bias=True, input_size=32, conv1_stride=1, is_vis=False):
...
class HCRunner(object):
    ...
    def __init__(self, low_dim=512, low_dim2=128, ratio1=3, ratio2=2, batch_size=128, input_size=32, conv1_stride=1,
        ...
        self.low_dim_list = [512, self.low_dim, self.low_dim2]
        self.ratio1 = ratio1
        self.ratio2 = ratio2
        self.input_size = input_size
        ...
        try:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                ...
                loss_1, loss_1_1, loss_1_2 = self.criterion(
                    feature_dict[FeatureName.Logits1], targets, params[-2], _l1_lambda_)
                loss_2, loss_2_1, loss_2_2 = self.criterion(
                    feature_dict[FeatureName.Logits2], targets2, params[-1], _l1_lambda_)
                ...
                loss = loss_1 + loss_2 if self.has_l1 else loss_1_1 + loss_2_1
                loss.backward()
            ...
            Tools.print(
                'Epoch: {}/{} Loss 1: {:.4f}({:.4f}/{:.4f}) Loss 2: {:.4f}({:.4f}/{:.4f})'.format(
                    epoch, len(self.train_loader), avg_loss_1.avg, avg_loss_1_1.avg,
                    avg_loss_1_2.avg,avg_loss_2.avg, avg_loss_2_1.avg, avg_loss_2_2.avg))
        finally:
            pass
...
if __name__ == '__main__':
    ...
    """
    # stl_10_class_1024_3level_128_1600_no_32_1_l1_sum_0_21_96_1
    # 2019-11-01 22:54:43 Update label 1385 .......
    # 2019-11-01 22:56:31 Epoch: [1385] 1-31328/5807 2-25148/4396
    # 2019-11-01 22:56:31 Epoch: 1385 lr=2.6485263216509374e-05 lambda=0.0
    # 2019-11-01 23:00:09 Epoch: 1385/3125 Loss 1: 1.1797(1.1797/0.1269) Loss 2: 0.8848(0.8848/72.9104)
    # 2019-11-01 23:00:09 Test [1385] .......
    # 2019-11-01 23:00:18 Test 1 1385 Top1=82.94 Top5=99.46
    # 2019-11-01 23:00:18 Test 2 1385 Top1=83.05 Top5=99.53
    # 2019-11-01 23:00:21 Test 1 1385 Top1=89.66 Top5=100.00
    # 2019-11-01 23:00:21 Test 2 1385 Top1=87.64 Top5=99.98
    # 2019-11-01 23:00:21 Saving..
    # 2019-11-01 23:00:21 Epoch: [1385] best accuracy: 83.05
    """
    ...
    _name = "stl_10_class_{}_2level_{}_{}_no_{}_{}_l1_sum_{}_{}{}_{}_{}".format(
    ...
    Tools.print("low_dim={} low_dim2={}".format(_low_dim, _low_dim2))
    Tools.print("ratio1={} ratio2={}".format(_ratio1, _ratio2))
