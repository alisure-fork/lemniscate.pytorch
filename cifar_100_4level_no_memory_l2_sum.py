    ...
    def _train_one_epoch(self, epoch, update_epoch=3):
        ...
        try:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                ...
                loss_1, loss_1_1, loss_1_2 = self.criterion(out_logits, targets, params[-4], _l1_lambda_)
                loss_2, loss_2_1, loss_2_2 = self.criterion(out_logits2, targets2, params[-3], _l1_lambda_)
                loss_3, loss_3_1, loss_3_2 = self.criterion(out_logits3, targets3, params[-2], _l1_lambda_)
...
if __name__ == '__main__':
    ...
    """
    # 11_cifar100_class_4096_2048_1024_512_1600_no_32_1_l1_sum_0_4321_134 1558
    56.98(4096) 57.20(2048) 57.01(1024) 56.22(512) test k=200
    59.94(4096) 62.51(2048) 62.00(1024) 62.43(512) train k=200
    """
    ...
    _linear_bias = False
    _pre_train = None
    # _pre_train = "./checkpoint/11_cifar100_class_4096_2048_1024_512_1600_no_32_1_l1_sum_0_4321_134/ckpt.t7"

    _name = "11_cifar100_class_{}_{}_{}_{}_{}_no_{}_{}_l1_sum_{}_{}{}{}{}_134".format(
