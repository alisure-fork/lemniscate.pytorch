...
class HCRunner(object):
    ...
    def __init__(self, low_dim=512, low_dim2=128, low_dim3=10, batch_size=128,
        ...
        self.train_set, self.train_loader, self.test_set, self.test_loader = CIFAR100Instance.data(
...
if __name__ == '__main__':
    ...
    """
    50.85(1024, 18375/2460) 50.72(256, 15276/1854) 49.97(64, 14329/2096)
    """
