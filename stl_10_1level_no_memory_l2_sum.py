...
class HCResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, low_dim=512, linear_bias=True, input_size=32, conv1_stride=1):
...
class HCRunner(object):
    ...
    def __init__(self, low_dim=512, ratio=1, batch_size=128, input_size=32, conv1_stride=1,
    ...
    def test(self, epoch=0, t=0.1, loader_n=1):
        _acc = KNN.knn(epoch, self.net, self.low_dim,
...
if __name__ == '__main__':
    ...
    """
    # stl_10_class_128_3level_1600_no_32_1_l1_sum_0_1_96_1
    # 2019-11-02 20:53:44 Update label 1578 .......
    # 2019-11-02 20:55:24 Epoch: [1578] 1-23399/4223
    # 2019-11-02 20:55:24 Epoch: 1578 lr=2.678121912202042e-05 lambda=0.0
    # 2019-11-02 20:59:07 Epoch: 1578/3125 Loss 1: 0.8515(0.8515/22.3298)
    # 2019-11-02 20:59:07 Test [1578] .......
    # 2019-11-02 20:59:16 Test 1 1578 Top1=79.79 Top5=99.12
    # 2019-11-02 20:59:19 Test 1 1578 Top1=85.36 Top5=100.00
    # 2019-11-02 20:59:19 Saving..
    # 2019-11-02 20:59:19 Epoch: [1578] best accuracy: 79.79
    """
    ...
    runner = HCRunner(low_dim=_low_dim, ratio=_ratio, linear_bias=_linear_bias, has_l1=_has_l1, input_size=_input_size,
                      conv1_stride=_conv1_stride, l1_lambda=_l1_lambda, is_adjust_lambda=_is_adjust_lambda,
