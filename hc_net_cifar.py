...
class KNN(object):
    ...
    def knn(epoch, net, low_dim_list, train_loader, test_loader, k, t, loader_n=1):
        ...
        train_labels = train_loader.dataset.train_labels if \
            hasattr(train_loader.dataset, "train_labels") else train_loader.dataset.targets
...
class DataSet(object):
    ...
    def __init__(self, data_set_name, data_root, batch_size):
        ...
        self.data_set_name_list = ["cifar10", "cifar100"]
        assert self.data_set_name in self.data_set_name_list
        self.data_root = data_root
        self.batch_size = batch_size
        self.train_set, self.train_loader, self.test_set, self.test_loader, self.class_name = self.produce_data()
        pass

    def produce_data(self):
        cifar_instance = CIFAR10Instance if self.data_set_name == self.data_set_name_list[0] else CIFAR100Instance
        train_set, train_loader, test_set, test_loader, class_name = cifar_instance.data(
            self.data_root, batch_size=self.batch_size)
        return train_set, train_loader, test_set, test_loader, class_name

    def data(self):
        return self.train_set, self.train_loader, self.test_set, self.test_loader
...
class HCRunner(object):
    ...
    def __init__(self, low_dim_list, ratio_list, data_set_name="cifar10", batch_size=128, is_adjust_lambda=False,
        ...
        self.train_set, self.train_loader, self.test_set, self.test_loader = DataSet(
            self.data_set_name, self.data_root, batch_size=self.batch_size).data()
    ...
    def _train_one_epoch(self, epoch, update_epoch=3):
        ...
        try:
            ...
            for i in range(len(self.low_dim_list)):
                now += " Loss {}: {:.4f}({:.4f}/{:.4f})".format(i + 1, avg_loss_list[i].avg,
...
if __name__ == '__main__':
    ...
    # hc_cifar100_5_dim_1024_512_256_128_64_ratio_54321_epoch_1600_bz_32_bias_1_lambda_0_sum
    52.94(1024, 19218/3713) 52.81(512, 16467/2836) 52.67(256, 13998/1870) 52.25(128, 12970/1617) 52.47(64, 14336/2588)
    
    # hc_cifar100_3_dim_4096_2048_1024_ratio_321_epoch_1600_bz_64_bias_1_lambda_0_sum
    55.95(256, 17134/3640) 56.38(128, 15806/3193) 55.34(64, 16300/3529)
    """
