...
class AttentionResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return out_logits, out_softmax, out_logits2, out_softmax2
    ...
    def knn(epoch, net, produce_class, produce_class2,
        ...
        if recompute_memory:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(temp_loader):
                out_logits, out, out_logits2, out2 = net(inputs)
...
class ProduceClass(nn.Module):
    ...
    def __init__(self, n_sample, low_dim, momentum=0.5):
        ...
        self.class_per_num = self.n_sample // self.low_dim + 1
    ...
    def _train_one_epoch(self, epoch, max_epoch, update_epoch=3):
        ...
        if epoch % update_epoch == 0:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                ...
                out_logits, out, out_logits2, out2 = self.net(inputs)
...
if __name__ == '__main__':
    ...
    """
    Top 1: 75.23(1024, 300, 2)/70.60(128, 300, 2)
    Top 1: 76.56(1024, 500, 1)/72.16(128, 500, 1)
    Top 1: 79.22(1024, 1000, 1)/74.48(128, 1000, 1)
    """

    _low_dim = 1024
    _low_dim2 = 128
    _name = "5_class_{}_softmax_2level_{}_1000".format(_low_dim, _low_dim2)
