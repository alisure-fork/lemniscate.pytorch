    ...
    def _train_one_epoch(self, epoch, update_epoch=3):
        ...
        try:
            if epoch % update_epoch == 0:
                ...
                Tools.print("Epoch: [{}] 1 {}/{}-{}".format(
                    epoch, self.produce_class.count, self.produce_class.count_2, self.train_loader.dataset.__len__()))
                Tools.print("Epoch: [{}] 2 {}/{}-{}".format(
                    epoch, self.produce_class2.count, self.produce_class2.count_2, self.train_loader.dataset.__len__()))
                Tools.print("Epoch: [{}] 3 {}/{}-{}".format(
                    epoch, self.produce_class3.count, self.produce_class3.count_2, self.train_loader.dataset.__len__()))
                pass
        finally:
            pass
        ...
        try:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                ...
                # Tools.print('Epoch: [{}/{}] {} {} {}'.format(epoch, len(self.train_loader),
...
if __name__ == '__main__':
    ...
    Top 1: 81.28(1024, 23776/3421), 80.96(128, 19316/2286), 80.76(10, 16214/1820)|(1000)
    
    Top 1: 81.38(1024, 24115/3497), 81.09(256, 19043/2048), 80.80(64, 16713/2112)|(1000)
    Top 1: 83.37(1024, 21816/3130), 83.24(256, 17229/1882), 82.91(64, 15189/2071)|(1000+500)
    Top 1: 84.58(1024, 21816/3130), 84.51(256, 17229/1882), 84.45(64, 15189/2071)|(1000+500+500)
    """
    ...
    # _pre_train = None
    _pre_train = "./checkpoint/9_class_1024_norm_count_3level_256_64_lr_500_no_memory/ckpt.t7"
    _name = "9_class_{}_norm_count_3level_{}_{}_lr_{}_no_memory_{}".format(_low_dim, _low_dim2, _low_dim3,
    ...
    runner = AttentionRunner(low_dim=_low_dim, low_dim2=_low_dim2, low_dim3=_low_dim3, linear_bias=_linear_bias,
