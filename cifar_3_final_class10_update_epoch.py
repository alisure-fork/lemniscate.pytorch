...
class AttentionResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, low_dim=10):
        ...
        self.linear_10 = nn.Linear(128, low_dim)
...
class AttentionRunner(object):
    ...
    def test(self, epoch=0, t=0.1, recompute_memory=1, loader_n=1):
        _acc = KNN.knn(epoch, self.net, self.produce_class, self.train_loader,
                       self.test_loader, 200, t, recompute_memory, loader_n=loader_n)
        return _acc
