...
class HCResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, low_dim=512, low_dim2=128, linear_bias=True, is_vis=False):
...
class HCRunner(object):
    ...
    def __init__(self, low_dim=512, low_dim2=128, ratio1=3, ratio2=2, batch_size=128,
